jQuery(document).ready(function(a) {
    ...
    a.cookie.json = !0, a(document).bind("reset_image", function() {
        ...
        c ? (f = wc_price_calculator_params.product_price * c, wc_price_calculator_params.minimum_price > f && (f = parseFloat(wc_price_calculator_params.minimum_price)), l > 0 && (k = f * l, f += k, n.html(j(k))), m.html(j(f)).trigger("wc-measurement-price-calculator-product-price-change", [c, f])) : (m.html("").trigger("wc-measurement-price-calculator-product-price-change"), l > 0 && n.html(""));
        var o = null;
